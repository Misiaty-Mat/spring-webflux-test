...
public class CustomerRouterConfig {
    ...
    public RouterFunction<ServerResponse> customerRoutes() {
        return route()
                ...
                .GET(CUSTOMER_PATH_ID, accept(APPLICATION_JSON), handler::getById)
                .POST(CUSTOMER_PATH, accept(APPLICATION_JSON), handler::createCustomer)
                .PUT(CUSTOMER_PATH_ID, accept(APPLICATION_JSON), handler::updateById)
                .PATCH(CUSTOMER_PATH_ID, accept(APPLICATION_JSON), handler::patchById)
